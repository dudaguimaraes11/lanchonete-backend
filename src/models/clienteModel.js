...
async deletar() {
    try {
        ...
        if (!this.id) {
            throw new Error('id necessario para deletar');
        }
        ...
        if (pedidoPago) {
            throw new Error('Não é possível deletar um cliente que possui um pedido pago');
        }

        // pedidos cancelados não bloqueiam o delete
